...
| Category | Score |
| ------ | ----- |
| License | 73 || Readme | 44 || Additional Documentation | 18 || Issue 
Templates | 5 || Contributing Guide | 4 || PR Templates | 3 || Code of Conduct |
1 || Changelog | 1 || Governance Model | 1 || GitHub: Vulnerability Alerts | 0 
|| GitHub: Code Scanning Alerts | 0 || GitHub: Secret Scanning Alerts | 0 || 
Secrets Detection | 0 || Continuous Testing Plan | 0 |
